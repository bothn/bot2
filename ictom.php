...
if ($tt=="" && $operacion == "SDMAPERTURA"){
	...
	//$URL_K = "http://192.168.127.132:13013/sendsms?username=foo&password=bar&from=99999999&to=50495298662&text=apertura,$site,$fera,$hoira,$id";
	//$FA_TT = fopen($URL_K,"r");
	...
	//mysql_query($main_ra,$conn_ra) or die(mysql_error());
	//$URL_K = "http://192.168.127.132:13013/sendsms?username=foo&password=bar&from=99999999&to=50495298662&text=cierre,$hofra,$id";
	//$FA_TT = fopen($URL_K,"r");
